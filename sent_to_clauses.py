...
def get_clause_list(sent):
    ...
    for t in sub_trees:
        ...
        for i in verb_phrases:
            doc = spacy_nlp(subject_phrase)
            subject_phrase = " ".join([ + " -- " + token.text if token.dep_ == "prep" else token.text for token in doc])
...
if __name__ == "__main__":
    ...
    # print(clause_list)
    sent = "Hello Bob. I am unhappy with your support staff and I want a refund."
